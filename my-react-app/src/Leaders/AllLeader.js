...
const AllLeader = () => {
    ...
    const LoadUsers = async () => {
        const result = await axios.get("http://localhost:1010/auth/leader");
    ...
    const handleDelete = async () => {
        await axios.delete(`http://localhost:1010/auth/leader/${deleteUserId}`);
        LoadUsers();
    ...
    return (
        <div style={containerStyle}>
            ...
            <div style={contentStyle}>
                ...
                <a href="/addleader"> <button type="button" className="btn btn-success mx-2" style={{ padding: '12px', marginTop: '40px', width: '150px' }}>NEW-LEADER</button></a>
                <div style={{ color: 'black', fontSize: '15px', fontWeight: 'bold', textAlign: 'center', fontFamily: 'Arial, sans-serif' }}> Village Leaders Details</div>
